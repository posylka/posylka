...
enum HttpStatus: int
{
    ...
    public function text(): string
    {
        return match ($this) {
            ...
            self::HTTP_FORBIDDEN => __('http.forbidden'),
            self::HTTP_NOT_FOUND => __('http.not_found'),
            ...
            self::HTTP_UNPROCESSABLE_ENTITY => __('http.unprocessable_content'),
            ...
            self::HTTP_INTERNAL_SERVER_ERROR => __('http.internal_server_error'),
